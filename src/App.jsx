...
function App () {
  ...
  return (
    <main className='w-screen h-screen bg-gray-950 text-white px-5 selection:bg-indigo-950'>
      ...
      <button className='absolute top-8 right-20 flex justify-center items-center bg-[#0000009f] border-2 border-indigo-600 w-12 h-12 rounded-md rotate-45 active:scale-90 hover:border-cyan-600' onClick={handleClick}>
